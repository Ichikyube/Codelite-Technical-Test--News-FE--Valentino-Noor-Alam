<div id="sidebar" class="flex w-32 h-screen px-3 overflow-x-hidden transition-transform duration-300 ease-in-out bg-white shadow-xl md:block md:w-60 lg:w-60"
    ...
    <div class="mt-10 space-y-6 md:space-y-10">
        <div id="profile" class="space-y-3">
            <img src="https://pbs.twimg.com/profile_images/1467997254929854470/mDYbXoVl_400x400.jpg"
                alt="Avatar user" class="w-10 mx-auto rounded-full md:w-16" />
            <div>
                <h2 class="text-xs font-medium text-center text-teal-500 md:text-sm">
                    Eduard Pantazi
                </h2>
        ...
        <div class="flex border-2 border-gray-200 rounded-md focus-within:ring-2 ring-teal-500">
            <input type="text"
                ...
                placeholder="Search" />
            <button class="hidden px-2 py-3 rounded-tr-md rounded-br-md md:block">
