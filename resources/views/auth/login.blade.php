<x-guest-layout>
    ...
    <form method="POST" action="{{ route('getlogin') }}">
        ...
        <div>
            ...
            <x-text-input id="email" class="block w-full mt-1 border-slate-200 border-[1px]" type="email" name="email" :value="old('email')" required autofocus />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password" class="block w-full mt-1 border-slate-200 border-[1px]"
                            type="password"
                            name="password"
